...
// Основные настройки:
$recipients = ['przemek.stupnowicz@gmail.com']; // Получатели писем
...
$smtp_username = 'przemek.stupnowicz@gmail.com'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = '951015Pp!'; // Пароль почтового ящика, с которого будут отправляться письма

// Перенаправления на страницы (если JS отключен):
$success_page = '../mail/success.html'; // При успешной отправке
$error_page   = '../mail/error.html'; // При Ошибке
